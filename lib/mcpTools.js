...
const TOOLS = [
  {
    name: 'list_players',
    description: 'List all bots managed by Overflayer with lightweight status, position, health, loaded snippet metadata, and viewer port. Does not include snippet source code.',
    inputSchema: { type: 'object', additionalProperties: false, properties: {} }
  },
  {
    name: 'get_player',
    description: 'Get a single bot by username with lightweight status, state, inventory, and loaded snippet metadata. Does not include snippet source code.',
    inputSchema: {
